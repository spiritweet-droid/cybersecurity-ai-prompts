...
> Build a complete purple team emulation plan from a threat actor or malware family

---

## Overview

This prompt guides an AI assistant through a structured adversary emulation planner workflow.
...
**Skills demonstrated:** MITRE ATT&CK, purple teaming, detection engineering, threat intelligence
