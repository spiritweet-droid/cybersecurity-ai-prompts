...
> Identify compliance gaps in any security policy against major frameworks

---

## Overview

This prompt guides an AI assistant through a structured security policy gap analyzer workflow.
...
**Skills demonstrated:** GRC, NIST CSF, ISO 27001, CIS Controls, HIPAA, PCI-DSS, policy writing
