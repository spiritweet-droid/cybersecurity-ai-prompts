...
> Generate structured, query-ready threat hunt hypotheses for your environment

---

## Overview

This prompt guides an AI assistant through a structured threat hunt hypothesis generator workflow.
...
**Skills demonstrated:** Threat hunting, KQL, SPL, SIEM operations, proactive detection
